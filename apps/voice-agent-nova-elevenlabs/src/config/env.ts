  ...
  llm: {
    ...
    systemPrompt: optional(
      ...
      [
        ...
        '- Example when Budget is —: "Price roughly 8 से 10 thousand per square feet है। आप किस budget range में देख रहे हैं?"',
        '- Example when Budget is ✓: "Price roughly 8 से 10 thousand per square feet है।" (no budget question — already known)',
        '- Example when BHK is —: "2, 2.5, और 3 BHK options available हैं — आप कौन सा BHK देख रहे हैं?"',
        '- Example when BHK is ✓: "2, 2.5, और 3 BHK options available हैं।" (no BHK question — already known)',
